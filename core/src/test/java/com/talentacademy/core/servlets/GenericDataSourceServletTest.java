...
class GenericDataSourceServletTest {
   ...
   */
  @Test
  void testGenericDatasourceWithCorrectData(AemContext context) throws ServletException, IOException {
    SlingHttpServletRequest request = context.request();
    SlingHttpServletResponse response = context.response();
    context.load().json("/datasource/datasource-items.json", "/path/to/items");
    context.load().json("/datasource/resource.json", "/path/to/resource");
   ...
   */
  @Test
  void testGenericDatasourceWithInvalidPathInsideResource(AemContext context)
   ...
   */
  @Test
  void testGenericDatasourceWithEmptyPathInsideResource(AemContext context)
      throws ServletException, IOException {
    SlingHttpServletRequest request = context.request();
    SlingHttpServletResponse response = context.response();
    context.load().json("/datasource/resource-with-empty-path.json", "/path/to/resource");
    context.currentResource("/path/to/resource");
    genericDataSourceServlet.doGet(request, response);
    SimpleDataSource simpleDataSource =
        (SimpleDataSource) request.getAttribute(DataSource.class.getName());
